        ...
        <div class="col-span-4 w-full flex flex-col">
            ...
            <div class="mt-5 flex gap-3 items-center">
                <div class="flex flex-col w-1/3">
                    ...
                    <input name="priceProd" type="number" class="w-full outline-none border border-zinc-300 focus:text-orange-500 focus:no-underline focus:border-orange-500 p-2 px-4 ${prod.discount > 0 ? 'line-through' : ''}" value="${prod.cost}">
                </div>
                <div class="flex flex-col w-1/3">
